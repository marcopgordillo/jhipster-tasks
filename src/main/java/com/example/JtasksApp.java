...
public class JtasksApp {

    private static final Logger log = LoggerFactory.getLogger(JtasksApp.class);

    private final Environment env;

    public JtasksApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JtasksApp.class);
